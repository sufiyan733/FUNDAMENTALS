  ...
  return (
    <>
      ...
      <main style={{ position: "relative", zIndex: 10, paddingTop: 80, opacity: vis ? 1 : 0, transition: "opacity 1s cubic-bezier(.4,0,.2,1)" }}>
        ...
        <section style={{
          maxWidth: 1280, margin: "0 auto", padding: "80px 5vw 140px",
          position: "relative",
        }}>
          {/* ── AMBIENT BACKGROUND (below hero) ── */}
          <div style={{
            ...
            <div style={{
              position: "absolute", inset: 0,
              backgroundImage: "radial-gradient(circle, rgba(0,247,255,0.05) 1px, transparent 1px)",
              backgroundSize: "38px 38px",
              maskImage: "radial-gradient(ellipse 80% 80% at 50% 20%, black 20%, transparent 90%)",
              WebkitMaskImage: "radial-gradient(ellipse 80% 80% at 50% 20%, black 20%, transparent 90%)",
            }} />
            ...
            <div style={{
              ...
              width: "60%", height: "40%",
              background: "radial-gradient(ellipse, rgba(0,247,255,0.045) 0%, transparent 70%)",
              filter: "blur(45px)",
            ...
            <div style={{
              ...
              width: "30%", height: "22%",
              background: "radial-gradient(ellipse, rgba(255,179,71,0.03) 0%, transparent 70%)",
              filter: "blur(50px)",
            }} />
          </div>
          <style>{`
