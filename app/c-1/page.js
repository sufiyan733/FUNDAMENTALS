  ...
  return (
    <aside style={{
      ...
      <div style={{ marginBottom: 14 }}>
        <div style={{ fontFamily: T.mono, fontSize: 10, letterSpacing: 5, color: T.neon, fontWeight: 700, marginBottom: 8 }}>
          INSIGHT PANEL
        </div>
          ...
          {[
            ...
            <div key={label}>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                style={{ fontFamily: T.mono, fontSize: 13, fontWeight: 700, color, marginTop: 1 }}
              >
                {value}
              </motion.div>
            </div>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 6 }}>
                    <div style={{ fontFamily: T.mono, fontSize: 9, letterSpacing: 3, color: ins.color, fontWeight: 700 }}>
                      {ins.tip ? "⚡ " : ""}{ins.label}
                    </div>
                    <motion.div animate={{ rotate: isExpanded ? 90 : 0 }} style={{ color: T.text, fontSize: 12, fontWeight: 700 }}>›</motion.div>
                  </div>
                  <div style={{ fontFamily: T.display, fontWeight: 700, fontSize: 14, color: T.text, margin: "3px 0" }}>
                    {ins.title}
                  </div>
                  <AnimatePresence>
                    {isExpanded && (
                      <motion.div
                        ...
                        style={{ overflow: "hidden" }}
                      >
                        <div style={{ fontFamily: T.mono, fontSize: 13, color: T.text, lineHeight: 1.7, marginTop: 6 }}>
                          {ins.body}
                        </div>
                      </motion.div>
                    )}
                  ...
                  {!isExpanded && (
                    <div style={{ fontFamily: T.mono, fontSize: 11, color: T.text, lineHeight: 1.5, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {ins.body.slice(0, 48)}…
                    </div>
                  )}
                </div>
...
export default function CIntroPage() {
  ...
  return (
    <>
      ...
      {/*
        LAYOUT: sidebar(240px) + main(flex:7) + insight(350px)
        Main body gets ~70% of remaining space (roughly 70:30 relative to right panel).
        Total: 240 + main + 350. Main area gets all remaining width with padding.
      */}
